...
q_table = [
    [0 for _ in range(action_space_size)] for _ in range(state_space_size)
...
for episode in range(num_episodes):
    ...
    for step in range(max_steps_per_episode):
        ...
        next_state, reward, done, _, _ = env.step(
            action
        )  # the underscore is the throwaway variable. (idk why we are throwing it away) why is this line not working?
