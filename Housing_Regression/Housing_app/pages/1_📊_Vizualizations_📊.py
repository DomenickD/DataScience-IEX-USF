...
fig = px.bar(x=best_features, y=selector.scores_[:6], 
             labels={'x': 'Features',
...
fig = px.histogram(df, x="SalePrice", color_discrete_sequence=px.colors.qualitative.Light24_r)
...
fig = px.box(df, x="Overall Qual", y="SalePrice", 
