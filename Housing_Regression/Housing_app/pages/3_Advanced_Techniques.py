...
st.caption("This page will have techniques that were learned but not benefitial to the Ames Housing Dataset.")
...
Using this module with 100 estimators at a learning rate of 0.1, our boosting model obtained an accuracy of *89.36%*. 
""")
...
Using this model with a Logistic Regression model pipeline, we had 10 estimators. This gave us an accuracy of *89.00%*.
""")
...
To build the stacking model, I used SVR, Lasso, and a Random Forest Regressor. I then designated the final estimator as XGB Regression (because this was my highest rated raw model).
...
We used a hard voting method here because it is a classification problem and obtained an accuracy of *69.00%*.
""")