...
if input_text_nltk:
    ...
    filtered_words = [word for word in words if word.lower() not in stop_words and word.isalnum()]  # Also remove non-alphanumeric characters
    st.code(f"filtered_words = [word for word in words if word.lower() not in stopwords.words('english')]", language="python")
    ...
    st.code(f"""lemmatizer = WordNetLemmatizer()\nlemmatized_words = [lemmatizer.lemmatize(word) for word in filtered_words]""", language="python")
    ...
    st.code(f"""stemmer = PorterStemmer()\nstemmed_words = [stemmer.stem(word) for word in filtered_words]""", language="python")
